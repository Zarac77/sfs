...
{
    // public class DadosExemplo : CreateDatabaseIfNotExists<SfsContext>
    //public class DadosExemplo : DropCreateDatabaseAlways<SfsContext>
    public class DadosExemplo : DropCreateDatabaseIfModelChanges<SfsContext>
    {
        ...
        {
            new List<Pessoa> {
                new Aluno { Id = Guid.Parse("04725000-12AD-4C23-9D3F-64ECE28E6760"), Matricula = "2011.0004", Nome = "Westerbly Snaydley", Email = @"westerbly@gmail.com", Turma = "3C" },
